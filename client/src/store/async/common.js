    ...
    try {
        ...
        const info = {
            ...
            home: [
                ...
                'يمكنك حجز موعد (مناسبه/بصخة) لاكثر من شخص عن طريق ادخال الرقم القومي لكل منهم',
                'كل (مناسبه/بصخة) له عدد محدد من الحضور حتي نضمن سلامه الشعب في ظل الظروف الحاليه',
                `كل شخص له الحق في (مناسبه/بصخة) واحد فقط في فتره من ${dayMonthFormat(currentPhase.start)} وحتي ${dayMonthFormat(currentPhase.end)}`,
